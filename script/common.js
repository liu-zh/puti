var url_all = 'http://puti.maiyatang.info/api/';
// 检测是否登录
function openWin(name,isTrue, params) {
    //需要先登陆
...
function pullRefresh(){
    api.setCustomRefreshHeaderInfo({
        bgColor: '#E6E7E8',
        image: {
          pull: ['widget://image/load.png'],
          load: ['widget://image/load1.png']
        }
    }, function() {
        getLatestMessages1();
